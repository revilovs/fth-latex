...
%	verbose: der Text im Befehl \textverbose{} wird abgedrückt, andernfalls wird er ignoriert
...
Man kann sehr viel schreiben.\textverbose{ Dieser Text wird nur angezeigt, wenn die Option "verbose" gesetzt ist. Für das optimale Format, sollte kein Leerzeichen vor \textit{und} nach dem Befehlt vorhanden sein, da sonst im nicht-verbose Modus eine etwas größere Lücke entstehen kann.} Manchmal ist es besser, weniger zu schreiben.
...
\begin{table}[ht]
    \begin{synopticcomparisontable}{Mt 18:2-5}{Mk 9:36-37}{Lk 9:47b-48}
         \synopticentry{
             \grk{2 \synspecial{καὶ προσκαλεσάμενος} \synall{παιδίον ἔστησεν αὐτὸ} \synmtmk{ἐν μέσῳ αὐτῶν} 3 καὶ \synall{εἶπεν·}}
         }{
             \grk{36 καὶ \synmklk{λαβὼν} \synall{παιδίον ἔστησεν αὐτὸ} \synmtmk{ἐν μέσῳ αὐτῶν} \synspecial{καὶ ἐναγκαλισάμενος αὐτὸ} \synall{εἶπεν} αὐτοῖς·}
         }{
             \grk{\synmklk{ἐπιλαβόμενος} \synall{παιδίον ἔστησεν αὐτὸ} \synspecial{παρ’ ἑαυτῷ} 48 καὶ \synall{εἶπεν} αὐτοῖς·}
         }
 
         \synopticentry{
             \grk{\synspecial{ἀμὴν λέγω ὑμῖν, ἐὰν μὴ στραφῆτε καὶ γένησθε ὡς τὰ παιδία, οὐ μὴ εἰσέλθητε εἰς τὴν βασιλείαν τῶν οὐρανῶν. 4 ὅστις οὖν ταπεινώσει ἑαυτὸν ὡς τὸ παιδίον τοῦτο,} \synmtlk{οὗτός ἐστιν ὁ μείζων} \synspecial{ἐν τῇ βασιλείᾳ τῶν οὐρανῶν.}}
         }{
         }{
         }
 
         \synopticentry{
             \grk{5 καὶ \synall{ὃς ἐὰν δέξηται} \synmtmk{ἓν} \synall{παιδίον} \synmtmk{τοιοῦτο} \synall{ἐπὶ τῷ ὀνόματί μου, ἐμὲ δέχεται.}}
         }{
             \grk{37 \synall{ὃς ἂν} \synmtmk{ἓν τῶν τοιούτων} \synall{παιδίων δέξηται ἐπὶ τῷ ὀνόματί μου, ἐμὲ δέχεται·} \synmklk{καὶ ὃς ἂν ἐμὲ δέχηται,} \synspecial{οὐκ ἐμὲ} \synmklk{δέχεται} \synspecial{ἀλλὰ} \synmklk{τὸν ἀποστείλαντά με}}
         }{
             \grk{\synall{ὃς ἐὰν δέξηται} \synspecial{τοῦτο} \synall{τὸ παιδίον ἐπὶ τῷ ὀνόματί μου, ἐμὲ δέχεται·} \synmklk{καὶ ὃς ἂν ἐμὲ δέξηται, δέχεται τὸν ἀποστείλαντά με·}}
         }
 
         \synopticentry{
         }{
         }{
             \grk{\synspecial{ὁ γὰρ μικρότερος ἐν πᾶσιν ὑμῖν ὑπάρχων} \synmtlk{οὗτός ἐστιν μέγας}}
         }
